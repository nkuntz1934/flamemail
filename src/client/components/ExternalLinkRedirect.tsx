...
export function ExternalLinkRedirect() {
  ...
  return (
    <main className="animate-slide-up mx-auto max-w-2xl pt-2">
      <section className="overflow-hidden rounded-lg border border-zinc-800/60 bg-zinc-900/50">
        <div className="border-b border-zinc-800/60 bg-zinc-950/80 px-5 py-4 sm:px-6">
          <div className="flex items-center gap-3">
            <span className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-amber-500/10 text-amber-300">
          ...
          {target ? (
            <>
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                ...
                <Link
                  to="/"
                  className="inline-flex items-center justify-center rounded-lg border border-zinc-800/80 bg-zinc-950/40 px-4 py-2.5 text-sm font-medium text-zinc-400 transition-colors hover:border-zinc-700 hover:text-zinc-200"
                >
                  Back to inboxes
                </Link>
              </div>
